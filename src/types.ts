 ...
 */
export function resolveNode(node: Readonly<WebHTMLNode>): ResolvedNode {
  return {
    id: node.id,
...
export function createIdleDragState(): DragHandleState {
  return {
    activeMode: null,
    targetNodeId: null,
    selectedAnchor: null,
...
export function createDefaultViewport(): ViewportMatrix {
  return {
    scale: 1,
    offsetX: 0,
    offsetY: 0,
