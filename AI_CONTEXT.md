...
<!-- Auto-generated by scripts/generate-ai-context.js on 2026-06-11 -->
...
### react
- `/react/api-reference` — API Reference
- `/react` — @canvus/react
- `/react/installation` — Installation
- `/react/quickstart` — Quick Start
