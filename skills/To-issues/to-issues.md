...
### 5. Create the Local markdown issues

For each approved slice, create a issues within ISSUE.MD. if ISSUE.md does not exist create it inthe root folder. Use the issue body template below. If a ISSUE.md already exist overwrite it.
