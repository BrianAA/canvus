...
export class DrawHandler {
    ...
    claim(e, canvasPos, _hitNodeId, _containerRect) {
    ...
    onPointerMove(_e, canvasPos, _containerRect) {
        if (!this._isDrawing || !this._drawStartCanvas)
            return;
        this._drawCurrentCanvas = canvasPos;
        // Dynamically resolve target container for drop preview
        this.ctx.activeDropTarget = findDropTarget("__new_node__", canvasPos, this.ctx.tree, (id) => this.ctx.mount.getWrapper(id), (id) => this.ctx.mount.getContentRoot(id));
        this.ctx.render();
    }
...
//# sourceMappingURL=draw.handler.js.map